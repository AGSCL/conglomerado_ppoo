...
# Redondear ambas
tabla_prop_fila2 <- sprintf("%1.2f", tabla_prop_fila2)
tabla_prop_col2 <- sprintf("%1.2f", tabla_prop_col2)
...
tabla_combinada2 |> 
  ...
  kable_classic() |> 
  footnote(
    general = "6612= Un trimestre, TUS; 6623= Un trimestre, TSM",
    general_title = "Nota:",
...
ggplot(aes(x = glosa_pueblo_originario_rec, y = value, fill = variable)) + 
  ...
  "6623, Un trimestre, TSM y Comorbilidad(2)" = "#D2B48C", 
  "6612, Un trimestre TSM(1)" = "#E27A5B"
)) +
  labs(title = NULL,
       x = "Grupo Étnico",
